"""
Маппинг русских названий карт к изображениям на GitHub
"""
# GitHub CDN URL
GITHUB_BASE = "https://raw.githubusercontent.com/MagickWorldss/taro_tg/main"
# GitHub CDN база URL
GITHUB_BASE_URL = "https://raw.githubusercontent.com/MagickWorldss/taro_tg/main"

def get_card_image_path(card_name: str) -> str:
    """
    Получить полный GitHub URL для изображения карты
    """
    # Пути к файлам
    paths = {
        # Старшие арканы
    ...
    relative_path = paths.get(card_name)
    
    if not relative_path:
        return None
    
    # Возвращаем полный GitHub URL
    return f"{GITHUB_BASE_URL}/{relative_path}"


# Для совместимости
CARD_TO_IMAGE_PATH = {}  # Старый словарь не используется, используем функцию выше
